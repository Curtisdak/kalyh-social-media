    ...
    >
      <html lang="en">
        ...
        <body className={poppins.className}>
          ...
          >
            <div
              className={`w-full bg-background px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 fixed  z-40 text-primary `}
            >
              <Navbar />
            </div>
            <div
              className={`w-[100vw] bg-muted px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12 duration-100 ease-in-out`}
            >
              {children}
            </div>
          </ThemeProvider>
